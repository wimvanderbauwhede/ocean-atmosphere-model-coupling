...
const UINT M_GMCF_GMCF_atmosphere_gmcf = 73729;
const UINT M_GMCF_GMCF_ocean_gmcf = 73730;
...
const UINT S_CoreServices_BEGIN = 3;
...
const UINT NSERVICES = 3;
const UINT SERVICE_ADDRESSES[3]={1,2,3};
