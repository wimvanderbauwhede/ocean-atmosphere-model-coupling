...
set SCRAT    = $HOME/Git/ocean-atmosphere-model-coupling/201608_IOD_Saji/ocean
...
set logfile  = $Rundir/forced_refactored_new.log

echo " forced_refactored.sc started at " >>& $logfile   
date                          >>& $logfile   
echo "                      " >>& $logfile   
...
cd $Rundir
nice +10 $Rootdir/RefactoredSources/Shallow  >>& $logfile
...
echo " forced_refactored.sc  ended      " >>& $logfile   
date                           >>& $logfile   
